...
BP_cluster(2,:)=[E_Q_density_OA,E_Q_density_c0,E_Q_density_c1,...
    E_Q_IR0_OA,E_Q_IR0_c0,E_Q_IR0_c1];
...
ax.YAxis.LineWidth = 1; % Increase the line width of the Y-axis
ax.XAxis.LineWidth = 1; % Increase the line width of the Y-axis
saveas(gcf,"RiskPremia/Tau-independent/unique/moneyness_step_0d01/multivariate_clustering_9_27_45/Bitcoin_Premium/PK_ePDF_3287_backward_onlyVR_NB12_OAHVLV_ttm27_1-by-1.png")
