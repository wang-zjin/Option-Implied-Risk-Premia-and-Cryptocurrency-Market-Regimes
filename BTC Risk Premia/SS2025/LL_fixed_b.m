function [OBJ_FUN,gradient,logLik,mass,fP_norm,logLik_terms] = LL_fixed_b(theta,N,ln_fQ,r30,ln_sig_t,r_vec,ln_fQ_t,del,r_vec_pow,r30_pow)
...
%doing the next two outside the function speeds it up
if ~exist('r30_pow','var')
    r30_pow  = r30.^(1:N);
end
if ~exist('r_vec_pow','var')
    r_vec_pow = r_vec.^(1:N);
end
