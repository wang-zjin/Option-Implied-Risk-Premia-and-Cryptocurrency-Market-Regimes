...
% BP_VRP_SS(3,:)=[mean(IR),mean(IR(index0,:)),mean(ER_Q(index1,:))]*365/27;
...
writetable(tb_VIX_RV_VRP_cluster0,"data_prep/data_BTC/RiskPremia/multivariate_clustering_9_27_45/Variance_Risk_Premium/VRP_VIX_Corsi_RV_HV.csv");
writetable(tb_VIX_RV_VRP_cluster1,"data_prep/data_BTC/RiskPremia/multivariate_clustering_9_27_45/Variance_Risk_Premium/VRP_VIX_Corsi_RV_LV.csv");

%% Report VRP
tb_VIX_RV_VRP_cluster0 = readtable("data_prep/data_BTC/RiskPremia/multivariate_clustering_9_27_45/Variance_Risk_Premium/VRP_VIX_Corsi_RV_HV.csv");
tb_VIX_RV_VRP_cluster1 = readtable("data_prep/data_BTC/RiskPremia/multivariate_clustering_9_27_45/Variance_Risk_Premium/VRP_VIX_Corsi_RV_LV.csv");
...
info.cnames = strvcat('Overall','Cluster 0','Cluster 1');
info.fmt    = '%10.2f';
disp('Q average vs. VIX average (ttm=27)')
