function [theta_0,theta_b0_0,LL_0,theta_boot,theta_b0_boot,LL_boot,fig1,tab4,tab5,tab6] = bootstrap_BTC_ttm9(reps,T,block,N,ln_fQ_t,ln_sig_t,ln_fQ,r30,r_vec,del,lnRf,do_estimate,do_fig1,do_tab4,do_tab5,do_tab6)

% N: the order of polynomial
% ttm=9 version: loads/saves bootstrap_estimates_BTC_ttm9
...
% bootstrap
if ~do_estimate
   load data_outputs/bootstrap_estimates_BTC_ttm9 theta_boot theta_b0_boot LL_boot 
   if isgpuarray(ln_fQ)
...
if do_estimate && all(N(:)'==[1 2]) % We use N=1;2 while the original SS2025JFE paper set N=1:5
   ...
   save data_outputs/bootstrap_estimates_BTC_ttm9 theta_boot theta_b0_boot LL_boot theta_0 theta_b0_0 LL_0
end
